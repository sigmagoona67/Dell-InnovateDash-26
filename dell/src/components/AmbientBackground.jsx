...
export default function AmbientBackground({ variant = 'sky' }) {
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-0">
      <div className={`absolute ${style.leftPos} h-96 w-96 rounded-full ${style.left} blur-3xl`} />
      <div className={`absolute ${style.rightPos} h-80 w-80 rounded-full ${style.right} blur-3xl`} />
      {style.gradient && (
